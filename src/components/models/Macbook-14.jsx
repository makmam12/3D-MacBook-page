...
Files: macbook-14.glb [629.72KB] > D:\Solo Learn\Three.js\3D mackbook page\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacBookModel14(props) {
  ...
  const { nodes, materials, scene } = useGLTF('/public/models/macbook-14-transformed.glb')
...
scene.traverse((child) => {
  if(child.isMesh){
    //only change if not in the array;
